window.onload = function(){
  ...
  timerd = setInterval(function(){
   ...
   $(function(){
        ...
        let divWidth = $(".new").width()
        let divHeight = $(".new").height()

        let sliderWidth = $(window).width()
        let sliderHeight = $(window).height()

        $(".new").css({
            left:(sliderWidth/divWidth)/2,
            top:(sliderHeight/divHeight)/2
        })
    ...
    $(".star-card-1").delay(25000) .fadeIn(3000)
   

    $(".star-card-2").delay(4000).fadeIn(3000)
    $(".star-card-2").fadeOut(3000)

    $(".star-card-3").delay(11000).fadeIn(3000)
    $(".star-card-3").fadeOut(3000)

    $(".star-card-4").delay(18000).fadeIn(3000)
    ...
    $(".star-card-4").delay(22000).fadeIn(3000)
    $(".star-card-4").fadeOut(3000)
